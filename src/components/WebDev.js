...
import Web from "../assets/ServicePageImages/Web_developer.webp";
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start w-full">
        ...
        <div className="w-full md:w-1/2 flex-shrink-0 bg-white">
          <img
            ...
            className="w-full h-auto object-cover max-w-md lg:max-w-2xl hover:scale-105 transition-transform duration-300" // Adjust the max width of the image
          />
        </div>
      </div>
    </div>
