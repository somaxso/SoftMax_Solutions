...
import TestingImage from "../assets/ServicePageImages/Outsource.webp";
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start w-full">
        <div className="w-full md:w-1/2 flex-shrink-0">
          <img
            ...
            className="w-full h-auto object-cover max-w-md lg:max-w-3xl hover:scale-105 transition-transform duration-300"
          />
        </div>
